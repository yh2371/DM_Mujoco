...
class PPO:
    ...
    def __init__(self, policy_class, env, **hyperparameters):
        ...
        self.start_training_actor_ratio = 0.0
        ...
        self.cov_var = torch.full(size=(self.act_dim,), fill_value=0.15)
        ...
        while t_so_far < total_timesteps:                                                                       # ALG STEP 2
            ...
            for _ in range(self.n_updates_per_iteration):                                                       # ALG STEP 6 & 7
                ...
                for start in range(0, step, minibatch_size):
                    ...
                    if t_so_far > self.start_training_actor_ratio * total_timesteps: # actor loss is only updated after 20% of total timesteps
            ...
            if i_so_far % self.save_freq == 0:
                torch.save(self.actor.state_dict(), './checkpoints/ppo_actor_' + str(i_so_far) + '.pth')
                torch.save(self.critic.state_dict(), './checkpoints/ppo_critic_' + str(i_so_far) + '.pth')
    ...
    def _init_hyperparameters(self, hyperparameters):
        ...
        self.timesteps_per_batch = 10000                 # Number of timesteps to run per batch
        self.max_timesteps_per_episode = 300           # Max number of timesteps per episode
    ...
    def _log_summary(self):
        ...
        print(f"percent of timesteps: {round(t_so_far / self.total_time_steps * 100, 2)}%", flush=True)
